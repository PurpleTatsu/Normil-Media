    ...
    <div>
      <div className="about">
        ...
        <div id="clients">
          ...
          <div><a href="http://firstpaloalto.com/"><img src="https://github.com/PurpleTatsu/Normil-Media/blob/master/src/images/first-palo-alto.png?raw=true" alt="first palo alto" /></a></div>
        </div>
      </div>
    </div>
  )
