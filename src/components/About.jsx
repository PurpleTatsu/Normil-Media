    ...
    <div>
      <div className="about">
        ...
        <div id="clients">
          ...
          <div><img src="https://raw.githubusercontent.com/PurpleTatsu/Normil-Media-2020/main/src/images/blue-export-group.jpg" alt="blue export group" /></div>
          <div><a href="http://firstpaloalto.com/"><img src="https://raw.githubusercontent.com/PurpleTatsu/Normil-Media-2020/main/src/images/first-palo-alto.png" alt="first palo alto" /></a></div>
        </div>
      </div>
    </div>
  )
